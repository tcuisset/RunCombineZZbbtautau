# Resonant with (nearly) full Run2 central samples
...
# removed 5000,5500,6000 due to no events
MASSES=600,800,1000,1200,1400,2000,3000,3500,4000,4500


#################### parametrized DNN

python3 ../RunAsymptoticLimits.py --cfg ul_2016_HIPM_ZbbHtt_v12,ul_2016_ZbbHtt_v12,ul_2017_ZbbHtt_v12,ul_2018_ZbbHtt_v12 \
    --feat dnn_ZHbbtt_kl_1 --featureDependsOnMass --prd prod_240510 \
    --mass $MASSES \
    --cat ZbbHtt_elliptical_cut_90 --grp datacard_ZbbHtt_res &>log_Zbb.txt
# plot only
python3 ../RunAsymptoticLimits.py --cfg ul_2016_HIPM_ZbbHtt_v12,ul_2016_ZbbHtt_v12,ul_2017_ZbbHtt_v12,ul_2018_ZbbHtt_v12 \
    --feat dnn_ZHbbtt_kl_1 --featureDependsOnMass --prd prod_240510 \
    --mass $MASSES \
    --cat ZbbHtt_elliptical_cut_90 --grp datacard_ZbbHtt_res --run_ch False --run_year False --run_comb False


python3 ../RunAsymptoticLimits.py --cfg ul_2016_HIPM_ZttHbb_v12,ul_2016_ZttHbb_v12,ul_2017_ZttHbb_v12,ul_2018_ZttHbb_v12 \
    --feat dnn_ZHbbtt_kl_1 --featureDependsOnMass --prd prod_240510 \
    --mass $MASSES \
    --cat ZttHbb_elliptical_cut_90 --grp datacard_ZttHbb_res &>log_Ztt.txt
# plot only
python3 ../RunAsymptoticLimits.py --cfg ul_2016_HIPM_ZttHbb_v12,ul_2016_ZttHbb_v12,ul_2017_ZttHbb_v12,ul_2018_ZttHbb_v12 \
    --feat dnn_ZHbbtt_kl_1 --featureDependsOnMass --prd prod_240510 \
    --mass $MASSES \
    --cat ZttHbb_elliptical_cut_90 --grp datacard_ZttHbb_res --run_ch False --run_year False --run_comb False


#################### non-parametrized DNN
python3 RunAsymptoticLimits.py --config ZbbHtt_v12 --category ZbbHtt_elliptical_cut_90 --process-group-name datacard_ZbbHtt_res \
    --feat dnn_ZHbbtt_kl_1 --ver prod_240329 --mass $MASSES

for CHANNEL in etau mutau tautau combination; do
python3 PlotAsymptoticLimits.py --mass $MASSES --config ZbbHtt_v12  \
    --feat dnn_ZHbbtt_kl_1ZttHbb --ver prod_240329 --ch $CHANNEL &
done

### ZttHbb
python3 RunAsymptoticLimits.py --config ZttHbb_v12 --category ZttHbb_elliptical_cut_90 --process-group-name datacard_ZttHbb_res \
    --feat dnn_ZHbbtt_kl_1ZttHbb --ver prod_240329 --mass $MASSES

for CHANNEL in etau mutau tautau combination; do
python3 PlotAsymptoticLimits.py --mass $MASSES --config ZttHbb_v12  \
    --feat dnn_ZHbbtt_kl_1ZttHbb --ver prod_240329 --ch $CHANNEL &
done
...
# impacts
cp /grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/combine/RunCombineZZbbtautau/ResLimits_v3/ResLimits/ul_2018_ZbbHtt_v12/prod_240510_M1000/combination/dnn_ZHbbtt_kl_1_1000/dnn_ZHbbtt_kl_1_*_comb_os_iso.txt /grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/combine/RunCombineZZbbtautau/ResLimits_v3/ResLimits/ul_2018_ZbbHtt_v12/prod_240510_M1000/combination/dnn_ZHbbtt_kl_1_1000/dnn_ZHbbtt_kl_1_*_*_os_iso.root .


cp /grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/combine/RunCombineZZbbtautau/ResLimits_v3/ResLimits/ul_2018_ZttHbb_v12/prod_240510_M1000/combination/dnn_ZHbbtt_kl_1_1000/dnn_ZHbbtt_kl_1_*_comb_os_iso.txt /grid_mnt/data__data.polcms/cms/cuisset/ZHbbtautau/combine/RunCombineZZbbtautau/ResLimits_v3/ResLimits/ul_2018_ZttHbb_v12/prod_240510_M1000/combination/dnn_ZHbbtt_kl_1_1000/dnn_ZHbbtt_kl_1_*_*_os_iso.root .
...
python3 ../RunAsymptoticLimits.py --config ZbbHtt_v12 --category ZbbHtt_elliptical_cut_90 --process-group-name datacard_ZbbHtt_res  \
 --feat dnn_ZHbbtt_kl_1 --featureDependsOnMass --ver prod_240510 --mass 600,800,1000,1200,1400,2000,3000